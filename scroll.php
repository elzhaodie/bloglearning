    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <!-- First Blog Post -->
                <?php
                    // memunculkan nilai $nilai untuk bahan nilai awal memulai post
                    $penambahan = 3;
                    $limit = $_GET['page'];
                    $start_data = 0;
                    for ($i = 1; $i <= $limit; $i++) {
                        $nilai = $start_data + ($penambahan * ($i - 1));   
                    }
                    //
                    $query_limit = "SELECT * FROM posts LIMIT {$nilai},{$penambahan}";
                    $query_limit_row = mysqli_query($connection, $query_limit);
                    while($row = mysqli_fetch_assoc($query_limit_row)){
                ?>
                    <h2>
